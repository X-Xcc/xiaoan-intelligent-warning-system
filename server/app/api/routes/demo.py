...
</style></head><body><main class="shell"><section class="hero"><h1>夜市智防后端演示</h1><p>FastAPI 接口已运行，夜市预警、求助、上报和闭环数据来自同一份 SQLite 事件库。</p><div class="links"><a href="/docs">Swagger 文档</a><a href="/api/events/overview">JSON 数据</a></div></section><section id="stats" class="grid"></section><section><h2>实时夜市事件</h2><div id="events" class="events"></div></section></main><script>
