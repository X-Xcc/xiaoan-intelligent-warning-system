...
type CrossMarketDemoState = 'idle' | 'scanning' | 'linked' | 'confirmed' | 'dispatched';
...
const fallback: Overview = {
  ...
  events: [
    { id: 'YS-DEMO-001', title: '寻衅滋事', bay: '某某夜市', level: '高风险', source: '群众报警', status: '已提交', owner: '待指派', distance: '待测距', time: '21:18', updatedAt: '21:18', description: '该人员有暴力前科，属于重点人员且近期在本地多个夜市有五起相似的纠纷滋事类警情' },
